        ...
        <div className="card_why">
          ...
          <div className="ListDiv">
              <ul className="whyList">
                ...
                <li className="nav__list__item_2 text text--small text--regular">Holding certain amounts of FOT during a Snapshot guarantees you airdrops of NFTs, Future Tokens, etc.</li>
